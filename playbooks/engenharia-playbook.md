...
> | Lente Peixe | `docs/tech/tech-specification.md` | `1.10` | `v1.0` | `fluxo-pr-nunca-merge-local`, `commit-automatico-task-a-task`, `bootstrap-ci-branch-protection`, `automatico-vs-confirmacao-explicita` (git/CI) e `auditoria-consistencia-documentos` |
>
