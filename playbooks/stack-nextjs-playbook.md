...
> | --- | --- | --- | --- | --- |
> | Lente Peixe | `docs/prd.md` | `1.5` | `v1.3` | Referencia este arquivo inteiro em vez de manter a tabela de padrões inline (sem âncora específica) |
> | Lente Peixe | `docs/tech/tech-specification.md` | `1.18` | `v1.3` | Valores concretos do projeto: `cache-por-entidade` e `icones-lucide-react` |
>
