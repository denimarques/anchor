...
| Lente Peixe | `docs/tech/tech-specification.md` | `1.14` | `stack-nextjs-playbook.md` v1.3 | `cache-por-entidade`, `icones-lucide-react` |
| Lente Peixe | `docs/prd.md` | `1.2` | `engenharia-playbook.md` v1.2 | `fonte-corrente-valores-tecnicos` |
| Lente Peixe | `docs/tech/tech-specification.md` | `1.14` | `engenharia-playbook.md` v1.2 | `fluxo-pr-nunca-merge-local`, `commit-automatico-task-a-task`, `bootstrap-ci-branch-protection`, `automatico-vs-confirmacao-explicita`, `auditoria-consistencia-documentos` |
