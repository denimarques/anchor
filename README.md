...
| Projeto | Documento do cliente | `doc-version` registrado | Versão do playbook | Âncora(s) referenciada(s) |
| --- | --- | --- | --- | --- |
| Lente Peixe | `docs/prd.md` | `1.8` | `stack-nextjs-playbook.md` v1.3 | Referencia este arquivo inteiro em vez de manter a tabela de padrões inline (sem âncora específica) |
| Lente Peixe | `docs/tech/tech-specification.md` | `1.20` | `stack-nextjs-playbook.md` v1.3 | `cache-por-entidade`, `icones-lucide-react` |
| Lente Peixe | `docs/prd.md` | `1.8` | `engenharia-playbook.md` v1.2 | `fonte-corrente-valores-tecnicos` |
